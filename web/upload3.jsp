...
<div id="step2" style="display: none; padding:5px; margin: 3px; background-color: #DDEFFF"><h2>2. Select a study</h2><span id="spanstep2"><select id='selectStudy' name='selectStudy' onChange='init_step3();'></select></span></div>
<div id="step3" style="display: none; padding:5px; margin: 3px; background-color: #DDEFFF"><h2>3. Select an assay:</h2><span id="spanstep3"><select id='selectAssay' name='selectAssay' onChange='init_step4();'></select></span></div>
