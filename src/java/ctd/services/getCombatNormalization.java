 ...
 * @author kerkh010
 */
public class getCombatNormalization {

    private String password_ws;
    ...
    public String getCombatNormalization() throws SerializerException, FileNotFoundException, IOException, NoImplementationException {
        ...
        String password_client = getPassword_ws();
        ...
        if (webservice_password.equals(password_client)) {
            ...
            while (f.exists()==false){
                try {
                    ...
                    Logger.getLogger(getCombatNormalization.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        ...
        message = trans.serializeToString(info);
     ...
     */
    public void setPassword_ws(String password_ws) {
        this.password_ws = password_ws;
    }
